...
class DBUser(Base):
    ...
    credits: Mapped[Decimal] = mapped_column(Numeric(10, 4), nullable=False, default=0.0)
    ...
    def __repr__(self) -> str:
        ...
        """
        return (
            f"{self.__class__.__name__}(id={self.id!r}, is_active={self.is_active!r}, status={self.status!r})"
        )
