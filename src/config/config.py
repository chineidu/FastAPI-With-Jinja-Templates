...
class BulkheadConfig:
    ...
    prediction_semaphore_config: dict[str, int] = field(
        metadata={"description": "Configuration for prediction semaphores per model type"}
    )
...
class APIConfig:
    ...
    ratelimit: dict[str, dict[str, Any]] = field(metadata={"description": "Ratelimit configuration."})
